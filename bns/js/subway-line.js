    ...
    for (var i = 0; i < line_stations.length; i++) {
        ...
        for (var q = 0; q < line_transfers.length; q++) {
            ...
            if (!is_in_array(html_css_combo, html_css_combos)) {
                station_entry += '<div class="subway-line-mini '+N_lines[line_transfers[q]].css+'" style="background-color: '+N_lines[line_transfers[q]].color_bg+'; color: '+N_lines[line_transfers[q]].color_text+';"><div class="height_fix"></div><div class="content">'+N_lines[line_transfers[q]].html+'</div></div>';
